<%-- 
    Document   : edit2
    Created on : Sep 8, 2014, 1:37:58 PM
    Author     : grid
--%>
<%
/**
...
String OpenAgris_FromPreferences = preferences.getValue("OpenAgris", "");
String OpenAgrisEndPoint_FromPreferences = preferences.getValue("OpenAgrisEndPoint", "");

String Europeana = "false";//preferences.getValue("Europeana", "");
String EuropeanaEndPoint = "Endpoint";//preferences.getValue("EuropeanaEndPoint", "");
String CulturaItalia = "false";//preferences.getValue("CulturaItalia", "");
String CulturaItaliaEndPoint = "Endpoint";//preferences.getValue("CulturaItaliaEndPoint", "");
String Isidore = "false";//preferences.getValue("Isidore", "");
String IsidoreEndPoint = "Endpoint";//preferences.getValue("IsidoreEndPoint", "");
String Pubmed = "false";//preferences.getValue("Pubmed", "");
String PubmedEndPoint = "Endpoint";//preferences.getValue("PubmedEndPoint", "");
String Engage = "false";//preferences.getValue("Engage", "");
String EngageEndPoint = "Endpoint";//preferences.getValue("EngageEndPoint", "");



String NumberRecordsForPage=preferences.getValue("NumberRecordsForPage", "");
            System.out.println("VALORE_OPENAGRIS_FROMPEFERENCES: "+OpenAgris_FromPreferences);
            System.out.println("VALORE_OPENAGRISENDPOINT_FROMPREFERENCES: "+OpenAgrisEndPoint_FromPreferences);
            
            System.out.println("VALORE_NumberRecordsForPage: "+NumberRecordsForPage);
  
  
  
String OpenAgris_default = ((PortletConfig) request.getAttribute("javax.portlet.config")).getInitParameter("OpenAgris");            
...
String OpenAgrisValueFinal="";
String OpenAgrisEndPointFinal="";

if(OpenAgris_FromPreferences.equals("") || OpenAgris_FromPreferences.equals(null))
    OpenAgrisValueFinal=OpenAgris_default;
else
    OpenAgrisValueFinal=OpenAgris_FromPreferences;

if(OpenAgrisEndPoint_FromPreferences.equals("") || OpenAgrisEndPoint_FromPreferences.equals(null))
    OpenAgrisEndPointFinal=OpenAgrisEndPoint_default;
else
    OpenAgrisEndPointFinal=OpenAgrisEndPoint_FromPreferences;
            ...
            <form id="<portlet:namespace/>Preferences" action="<portlet:actionURL portletMode="edit"></portlet:actionURL>" method="post">
                ...
                <table>
                    ...
                    <tr class="rowList" style="height: 30px;">
                        ...
                        <td>
                            <input id="idOpenAgrisEndPoint" disabled  class="rounded" type="text" name="OpenAgrisEndPoint" value="<%=OpenAgrisEndPointFinal%>"<br> 
                        </td>
                    ...
                    <tr class="rowList" style="height: 50px;">
                        ...
                        <td>
                            <input id="idEuropeanaEndPoint" disabled class="rounded" type="text" name="EuropeanaEndPoint" value="<%=""%>"><br> 
                        </td>
                    </tr>
                    <tr class="rowList" style="height: 50px;"> 
                        <td><input type="checkbox" id="3" name="CulturaItalia" onClick="ckeckCulturaItalia()" >Cultura Italia</td>
                        <td>
                            <input id="idCulturaItaliaEndPoint" disabled class="rounded" type="text" name="CulturaItaliaEndPoint" value="<%=""%>"><br> 
                        </td>
                    </tr>
                    <tr class="rowList" style="height: 50px;">
                        <td><input type="checkbox" id="4" name="Isidore" onClick="ckeckIsidore()" >Isidore</td>
                        <td>
                            <input id="idIsidoreEndPoint" disabled class="rounded" type="text" name="IsidoreEndPoint" value="<%=""%>"><br> 
                        </td>
                    </tr>
                     <tr class="rowList" style="height: 50px;">
                        <td><input type="checkbox" id="5" name="Pubmed" onClick="ckeckPubmed()" >Pubmed</td>
                        <td>
                            <input id="idPubmedEndPoint" disabled class="rounded" type="text" name="PubmedEndPoint" value="<%=""%>"><br> 
                        </td>
                    </tr>
                     <tr class="rowList" style="height: 50px;">
                        <td><input type="checkbox" id="6" name="Engage" onClick="ckeckEngage()" >Engage</td>
                        <td>
                            <input id="idEngageEndPoint" disabled class="rounded" type="text" name="EngageEndPoint" value="<%=""%>"><br> 
                        </td>
                    </tr>
...
<script type="text/javascript" >
    ...
    <%if(OpenAgrisValueFinal.equals("true")){%>
    ...
    <%} %>  
        ...
        function resetForm() {
            ...
            document.getElementById("idOpenAgrisEndPoint").value="<%=OpenAgrisEndPointFinal%>";
