...
public class QueryEuropeana {
    ...
    public static String getEuropeanaTitle(String resource) 
    ...
    public static String getEuropeanaAuthors(String resource) 
            throws RepositoryException, MalformedQueryException, UnsupportedEncodingException 
    {
    ...
    public static String getEuropeanaDescription(String resource) 
            throws RepositoryException, MalformedQueryException, UnsupportedEncodingException 
    {
    ...
    public static String getEuropeanaIdentifier(String resource) 
            throws RepositoryException, MalformedQueryException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaPublisher(String resource) 
    ...
    public static ArrayList getEuropeanaSubject(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaSource(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaLanguage(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaDate(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaContributor(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaRights(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static String getEuropeanaCoverage(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
        String sCoverage = "";
        String coverages = "";
    ...
    public static String getEuropeanaType(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
        ...
        try {
            ...
            //System.out.println("QUERY TYPE Europeana-->" + queryStringType);
            ...
            if (result_type.hasNext()) 
            {
                while (result_type.hasNext()) 
                {
                   ...
                   if (bindingSet_type.getValue("type") != null) 
                   {
                      ...
                      //  System.out.println("TYPE--->"+typeFinale);
            ...
            for (int i = 0; i < arrayEuropeanaTypes.size(); i++) {
                if (!arrayEuropeanaTypes.get(i).toString() .equals("")) {
                    
                    sTypes = sTypes + "##" + arrayEuropeanaTypes.get(i).toString();
                    //System.out.println("TYPE--->"+sTypes);
                }
            }
        } catch (QueryEvaluationException ex) {
            Logger.getLogger(SemanticQuery.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static ArrayList getEuropeanaFormat(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
    ...
    public static ArrayList getEuropeanaRelation(String resource) 
            throws RepositoryException, MalformedQueryException, QueryEvaluationException, UnsupportedEncodingException 
    {
